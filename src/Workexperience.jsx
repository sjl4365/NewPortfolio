        ...
        <div className="RelevantWorkExperience">
            ...
            <div>
                <div className="JobFour">
                    <h3 className="MOT">Quality Engineer @ TD Bank</h3>
                    <h4 className="DateFour">Jan 2026 - Apr 2026</h4>
                </div>
                <ul className="listOne">
                    <li>
                    Develop and execute automated test scripts using Selenium WebDriver and Java to validate EasyWeb platform functionality, ensuring 
                    cross browser compatibility and performance across multiple test environments
                    </li>
                    <li>
                        Implement test automation frameworks within CI/CD pipelines using Jenkins and Git to enable continuous testing,
                        integration, and delivery practices for faster release cycles
                    </li>
                    <li>
                        Create and maintain comprehensive test plans, test cases, and defect reports in JIRA while performing Adhoc testing
                        and collaborating with cross functional development teams
                    </li>
                </ul>
            </div>
